...
Open-source developer from Mossoró, Rio Grande do Norte — Brazil. I build tools that make software development more reliable: **drift detection**, **dependency security**, **agent observability**, and **developer infrastructure**.
...
[![ghstats](https://img.shields.io/badge/ghstats-v0.1.0-2ea44f?logo=python&logoColor=white)](https://github.com/yunaremaia/ghstats)
...
- **Drift Detection** — version drift between docs and toolchain files (Dockerfile, build.gradle, go.mod, etc.)
- **Dependency Security** — typosquat detection, multi-ecosystem scanning
- **Agent Observability** — token tracking, memory health, session analysis
- **Developer Infrastructure** — CI hygiene, test selection, context management
- **Open Source** — contributing to Apache, Modular, ripgrep, Biopython, and more
...
- 🧬 **[biopython/biopython](https://github.com/biopython/biopython)** — official contributions

## Stack

`Python` `TypeScript` `Rust` `Bash` · git-first workflows · drift detection · agent infrastructure · CI/CD

## Support

- **Solana / cbBTC:** `Eeztv1nCYUt1fwGWpzKC948gaWfjejYCAuLtUMgzDWbW`
- Or collaborate: pick an [open issue](https://github.com/search?q=author%3Ayunaremaia+is%3Aissue+is%3Aopen&type=issues) I maintain
